 ...
 */
public class PhotoGalleryFragmentBakWithHandlerThread extends Fragment {
    ...
    public static PhotoGalleryFragmentBakWithHandlerThread newInstance() {
        return new PhotoGalleryFragmentBakWithHandlerThread();
    }
