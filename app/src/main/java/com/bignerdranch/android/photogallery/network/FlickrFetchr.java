...
public class FlickrFetchr {
    ...
    public List<GalleryItem> fetchItemsUsingGson() {
        ...
        try {
            ...
            items.addAll(parseItemsUsingGson(jsonString));
...
//    private String url = String.format(urlTemplate, apiKey);
    ...
    private List<GalleryItem> parseItemsUsingGson (String jsonBody) throws JSONException {
